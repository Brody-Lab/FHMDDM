...
include("hessian.jl")
include("latent_variable_parameters.jl")
...
include("mixture_of_Poisson_GLM/gainmixture.jl")
include("mixture_of_Poisson_GLM/derivatives.jl")
...
include("mixture_of_Poisson_GLM/negativebinomial.jl")
...
include("psychophysical_kernel/psychophysical_kernel_model.jl")
include("psychophysical_kernel/pericommitment_choice_model.jl")
include("sampling.jl")
include("save.jl")
include("tests.jl")
end
