...
Posterior probability of the accumulator conditioned on the choice
...
RETURN
-`fb`: Element `fb[t][j]` represents the probability of the accumulator being in the j-th state conditioned on the behavioral choice: p(aₜⱼ = 1 ∣ 𝑑)
"""
